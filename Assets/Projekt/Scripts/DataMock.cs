...
public static class DataMock
{
    public static List<BaseGuidName> GetMockSubjects()
    {
        ...
        {
            new SubjectModel(new("4e4287b8-d413-4ddc-96d7-227034a7f8a2"), "Matematik"),
            new SubjectModel(new("9b6d09ea-2476-426e-b708-b34325451e4b"), "Dansk"),
            new SubjectModel(new("8ee63da1-fee9-4189-8391-996b648745c9"), "Engelsk")
        };
    }
...
[Serializable]
public class SubjectModel : BaseGuidName
{
    public SubjectModel() : base()
    {
        
    }
    public SubjectModel(Guid id, string name) : base(id, name)
    {
    }
}
...
public class AssigmentModel : BaseGuidName
{
    public string Question { get; set; }
    public string Answer { get; set; }
    public Guid? NextAssignmentId { get; set; }

    public AssigmentModel() : base()
    {
        
    }
    public AssigmentModel(Guid? id, string name) : base(id, name)
    {
    }

    public AssigmentModel(Guid? id, string name, string question, string answer, Guid? nextAssignmentId)
        : base(id, name)
    {
        Question = question;
        Answer = answer;
